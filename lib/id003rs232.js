...
var CMD = {
  ...
  // setcount vracia rovnaky response f0 ako currencypath, resp vracia f0 20 d2 a currencypath vracia f0 20 d0
};
...
Id003Rs232.prototype.parseSetCount = function parseSetCount(rawData) {
  if (rawData[4]=='d2') {
    var number = rawData[5]; // pocet v hex
    var box = rawData[7];
    return { status: 'ok', number: number, box: box };
  }
};
