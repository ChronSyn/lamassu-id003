...
var CMD = {
  ...
  version: new Buffer([0xfc, 0x05, 0x88, 0x6f, 0x5f]),
  //                                                      stack1            stack2            crc
  currencypath: new Buffer([0xFC, 0x0D, 0xF0, 0x20, 0xD0, 0x02, 0x00, 0x01, 0x08, 0x00, 0x02, 0xBA, 0x42]),
  //                                                 cnt   box   crc
  payout: new Buffer([0xFC, 0x09, 0xF0, 0x20, 0x4A, 0x01, 0x02, 0x8B, 0x5C]),
  count: new Buffer([0xFC, 0x07, 0xF0, 0x20, 0x92, 0x2B, 0xA7]),
  currentcount: new Buffer([0xFC, 0x07, 0xF0, 0x20, 0xa2, 0xa8, 0x96]),
  emergency: new Buffer([0xFC, 0x07, 0xF0, 0x20, 0x4D, 0x51, 0x89]),
  //                                                  cnt         box
  setcount: new Buffer([0xFC, 0x0A, 0xF0, 0x20, 0xD2, 0x32, 0x00, 0x01, 0x0D, 0xD2]),
  //                                                         cnt         box
  setcurrentcount: new Buffer([0xFC, 0x0A, 0xF0, 0x20, 0xe2, 0x02, 0x00, 0x01, 0x51, 0x18]),
};
...
Id003Rs232.prototype.open = function open(cb) {
  ...
  var serial = new SerialPort(this.config.device, config);
